    ...
    <div class="flex-row project-overview">
      <div class="project-overview-info ibox">
        ...
        <div style="color: #98a6ad;padding-top: 10px;">
          Jitask 是一款精简、多租户的项目管理软件，提供任务管理、文档管理两大板块，内置权限管理，项目报表，项目配置，需求任务关联等功能，目前仅支持saas部署。我们的追求：小而精，不做多余功能的。使命：用好系统，少用系统，不粘滞用户。
          <br/>
          <br/>
          系统使用 Golang + Vue 2.x + bootstrap-vue 开发，由 Jimmy 独自开发，用时近两年，为脱产期间和闲暇时间开发，数据库使用 Mysql 8.x，Redis 5.x。使用阿里云 docker-compose 公有部署。
          <br/>
          <br/>
