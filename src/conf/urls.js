...
let urls = {
    ...
    team_recent_spaces: '/api/team/{0}/recent_spaces',
    ...
    space_pin: '/api/team/{0}/space/{1}/pin',
    space_unpin: '/api/team/{0}/space/{1}/unpin',
    ...
    project_pin: '/api/team/{0}/project/{1}/pin',
    project_unpin: '/api/team/{0}/project/{1}/unpin',
