let urls = {
    ...
    issue_type_field_option_list: '/api/team/{0}/issue_types/field_options/{1}',
    issue_type_field_update: '/api/team/{0}/issue_types/field/update',
    ...
    task_update: '/api/team/{0}/project/{1}/issue_type/{2}/tasks/update_deadline',
