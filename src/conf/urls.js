let urls = {
    ...
    issue_type_field_list: '/api/team/{0}/issue_types/field',
    issue_type_list: '/api/team/{0}/issue_types/list',
    issue_type_priority: '/api/team/{0}/issue_types/priority',
    issue_type_status: '/api/team/{0}/issue_types/status',
