<template>
  <transition name="fade">
    <div class="leftBar" v-if="sidebar.opened">
      <div class="left-header flex-row">
        <div class="sidebar-logo task-flex-auto">
        ...
        <div class="task-flex-none sidebar-toggle-icon" @click="close">
...
import Link from '../../components/common/control/link';
