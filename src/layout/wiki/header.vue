<template>
  <div id="header" class="flex-row align-items-center wiki-header">
    ...
    <div class="flex-column wiki-header-new">
      <AddButton title="新建页面" :plus="true" @submit="add"/>
    </div>
    <div class="task-flex-auto"></div>
    <UserCenterAvatar/>
  </div>
</template>

<script>
import AddButton from '../../components/common/button/universal';
...
<style scoped>
.wiki-header { flex: 0 0 48px;background-color: #313a46;padding-left: 10px; }
.wiki-header-link { margin-left: 5px;font-size: 22px;font-weight: bold;color: #ffffff;letter-spacing: 3px;text-align: center; }
.wiki-header-title { margin-left: 20px; }
.wiki-header-title a { color: #ffffff;flex: 0 0 auto;font-size: 16px;letter-spacing: 3px;font-family: 'museo-1', 'museo-2', Verdana; }
.wiki-header-new { margin-left: 20px; }
</style>