<template>
  <div id="header" class="flex-row align-items-center">
    <div style="flex: 0 0 auto;">
      <router-link :to="{ name: 'Main' }">
        <div style="margin-left: 10px;" class="flex-row align-items-center">
          <div style="flex: 0 0 auto;">
          ...
          <div style="flex: 0 0 auto;margin-left: 5px;">
            <span style="font-size: 22px;font-weight: bold;color: #ffffff;letter-spacing: 3px;margin: 0 0 0 0;text-align: center;">Jitask</span>
          </div>
        </div>
      </router-link>
    </div>
    <div class="name" style="margin-left: 20px;flex: 0 0 auto;">
