          ...
          <div style="flex: 1;align-items: center;justify-content: flex-end;" class="td last flex-row">
            <div class="flex-row task-attr align-items-center" style="margin-right: 20px;">
              ...
              <div style="flex: 0 0 auto;margin-left: 5px;">
                <router-link :to="{ name: 'ComponentIssueTypeDesigner', params: { team: team, project: project, com:'designer', attr: 'field', issue_type: item.uuid } }">工作项属性</router-link>
              </div>
            </div>
            <div class="flex-row task-attr align-items-center" style="margin-right: 20px;">
              <div style="flex: 0 0 auto;">
              ...
              <div style="flex: 0 0 auto;margin-left: 5px;">
                <router-link :to="{ name: 'ComponentIssueTypeDesigner', params: { team: team, project: project, com:'designer', attr: 'issue_type_permission', issue_type: item.uuid } }">工作项权限</router-link>
              </div>
            </div>
            <div class="flex-row task-attr align-items-center" style="margin-right: 20px;">
              <div style="flex: 0 0 auto;">
              ...
              <div style="flex: 0 0 auto;margin-left: 5px;">
                <router-link :to="{ name: 'ComponentIssueTypeDesigner', params: { team: team, project: project, com:'designer', attr: 'issue_type_flow', issue_type: item.uuid } }">工作项工作流</router-link>
              </div>
            </div>
            <div class="flex-row task-attr align-items-center" style="margin-right: 20px;">
              <div style="flex: 0 0 auto;">
