<template>
  <div id="personal">
    ...
    <div :class="{active: (currentIndex == 2)}"><router-link to="/main/center/safe">安全设置</router-link></div>
...
<style scoped>
#personal { flex: 0 0 auto;width: 218px;height: 100%;padding: 0;flex-direction: column; }
