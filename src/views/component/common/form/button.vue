<template>
  <div style="display: flex;flex-direction: row;background-color: #36c6d3;height: 100%;padding: 5px 5px 5px 10px;cursor: pointer;align-items: center;border-radius: 3px;outline: none;box-shadow: none;" v-on:click="onsubmit">
    <div style="flex:0 0 auto;flex-direction: column;align-items: center;height: 100%;display: flex;outline: none;box-shadow: none;">
      <div style="flex: 1;align-items: center;vertical-align: center;display: flex;outline: none;box-shadow: none;">
        <div style="flex: 0 0 auto;display: flex;outline: none;box-shadow: none;">
    ...
    <div class="button flex-column">{{title}}</div>
  </div>
</template>
...
<style scoped>
.button { color:#ffffff;padding:0 5px 0 5px;font-size:14px;align-items: center;outline: none!important;box-shadow: none!important; }
</style>