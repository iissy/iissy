<template>
  <div style="overflow:hidden;width: 300px;height: 30px;position: relative;">
    ...
    <input type="text" v-model="name" name="name" class="form-control" style="padding-left: 40px;height: 100%;padding-top: 5px;padding-bottom: 5px;" :placeholder="placeholder">
  </div>
</template>
