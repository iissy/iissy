<template>
  <div style="flex: 1;padding: 20px;" class="g-container">
    ...
    <div id="task-list" style="flex-direction: column;flex: 1;display: flex;overflow: auto;margin-top: 10px;">
      <div v-for="t in tasks" v-bind:key="t.uuid" class="flex-row task-item" @click="select_task(t.uuid)">
