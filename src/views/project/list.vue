...
#project-top-row { display: flex;flex-direction: row;-webkit-flex: 0 1 auto;flex: 0 1 auto;-webkit-flex-direction: row;border-bottom: 1px solid #ccc;margin-top: 10px;width: 100%; }
...
.table-row-header { flex: 0 0 auto;display: flex;min-width: 1800px;border-bottom: 1px solid #e8e8e8;border-top: 1px solid #e8e8e8; }
.table-row { flex: 0 0 auto;display: flex;border-bottom: 1px solid #e8e8e8;min-width: 1800px; }
.table .th { flex: 1 0 auto;width: 200px;background-color: #f8f8f8;padding: 5px 0 5px 20px; }
.table .td { flex: 1 0 auto;width: 200px;padding: 5px 0 5px 20px; }
.table .big { min-width: 400px; }
</style>